            ...
            <div className="layout">
                <div className="note">
                    <div className="text">
                        ...
                        hackathon on 23rd November. <span className="highlight"> However</span>, if you are from another school 
                        and really want to take part, reach out to us <span className="highlight">through email</span>. </p>
                    </div>
                </div>
                <div className="note">
                    <div className="text">
                ...
                <div className="note">
                    <div className="text">
                        ...
                        <a href="mailto:18bshahm@qerdp.co.uk" className="highlight"> 18bshahm@qerdp.co.uk</a> or <span className="highlight">
                        Harik </span> at <a href="mailto:18lsodhih@qerdp.co.uk" className="highlight"> 18lsodhih@qerdp.co.uk</a>.</p>
                    </div>
                </div>
                <div className="note">
                    <div className="text">
                ...
                <div className="note">
                    <div className="text">
                        ...
                        any <span className="highlight">extra tools</span> (e.g. sketchpad) if helpful, but they’re <span className="highlight">optional</span>. 
                ...
                <div className="note">
                    <div className="text">
                        ...
                        <br />
                        <p>Sign up via the <span className="highlight">Microsoft Form </span> 
                        on <a href="https://eqe.fireflycloud.net/set-tasks/374649" target="_blank" rel="noopener noreferrer" className="highlight" >eQE</a> by 
                        3rd November. Due to high demand, places are <span className="highlight">first come</span>, <span className="highlight">first served</span>. 
                ...
                <div className="note">
                    <div className="text">
                        ...
                        <br />
                        <p>It is preferred that you sign up <span className="highlight">with a team</span> so that you can compete with people you already know. 
