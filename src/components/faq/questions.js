            ...
            <div className="layout">
                <div className="note">
                    <div className="text">
                        ...
                        <br />
                        <p>Sign up via the Microsoft Form (<span className="highlight">top right</span>) by december 1st. Due to high demand, places are <span className="highlight">first come, first served</span>. 
                ...
                <div className="note">
                    <div className="text">
                        ...
                        <br />
                        <p><span className="highlight">Anyone</span> can attend the 
                        hackathon!</p>
                    </div>
                </div>
                <div className="note">
